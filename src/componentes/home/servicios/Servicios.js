        ...
        <div className="container servicios">
            ...
            <div className="row">
                ...
                <div className="col-lg-4">
                    <svg className="bd-placeholder-img rounded-circle" src={process.env.PUBLIC_URL + 'images/img3.jpg'} width="140" height="140" xmlns="https://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice" focusable="false" role="img" aria-label="Placeholder: 140x140">
